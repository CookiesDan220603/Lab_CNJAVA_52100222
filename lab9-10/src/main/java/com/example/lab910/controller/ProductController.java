...
import com.example.lab910.dto.ProductDto;
import com.example.lab910.model.Product;
import com.example.lab910.service.ProductServiceImp;
...
public class ProductController {
    ...
    public ResponseEntity<Product> updateProdById(@PathVariable("id") Long id, @RequestBody ProductDto productDto) {
        Product product = Product.builder().code(id).price(productDto.getPrice())
